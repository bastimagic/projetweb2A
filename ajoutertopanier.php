...
if(!isset($_COOKIE[$cookie_name])) {
	...
	$panierr  = new panier($token,$_GET['prx']); //create panier  ajouter le prix de prduit (id )
	...
	$panierrc->modifierpanier($_COOKIE[$cookie_name],$_GET['prx']); // modifier le total avec prix de produit (id)
	// modifier panier
}
