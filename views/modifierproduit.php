              ...
              <strong> Mofifier un produit</strong> Détails
                                                    ...
                                                    <div class="card-body card-block">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="file" id="img" name="imageP" value="<?php echo $imageP;?>" class="form-control"><small class="form-text text-muted"></small></div>
                                                         ...
                                                         <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="nomP" name="nomP" value="<?php echo $nomP;?>" class="form-control"><small class="form-text text-muted" required></small></div>
                                                            </div>
                                                        <div class="row form-group">
                                                                <div class="col col-md-3"><label class=" form-control-label">Descrption du produit</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="descP" name="descP" value="<?php echo $descP;?>"  class="form-control"><small class="form-text text-muted"></small></div>
                                                           ...
                                                           <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="number" id="qteP" name="qteP" value="<?php echo $qteP;?>"  class="form-control"><small class="help-block form-text" required> </small></div>
                                                            </div>
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label for="password-input" class=" form-control-label">Prix TND du produit </label></div>
                                                                <div class="col-12 col-md-9"><input type="number" id="prixP" name="prixP" value="<?php echo $prixP;?>" class="form-control"><small class="help-block form-text" required></small></div>
                                                            </div>
                                                             <div class="row form-group">
