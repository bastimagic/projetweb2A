...
$result=$db->query('select * from livraison ORDER BY ID_commande');
?>
<?php
if (isset($_GET['search'])&&!empty($_GET['search'])) {
    $search=htmlspecialchars($_GET['search']);
    $result=$db->query('select * from livraison WHERE idL LIKE "%'.$search.'%" or ID_commande LIKE "%'.$search.'%" or adresse LIKE "%'.$search.'%" or date LIKE "%'.$search.'%"');
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"> Listes des Livraisons </strong>
                            </div>
                            <div class="card-body">
                            ...
                            <a href="modifierlivraison.php?idL=<?PHP echo $row['idL']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                           
                            <form method="POST" action="supprimerlivraison.php">
                                <input type="submit" name="Delete" value="Delete" class="btn btn-danger btn-xl">
