...
if (isset($_GET['search'])&&!empty($_GET['search'])) {
    ...
    $result=$db->query('select * from fournisseur WHERE nomF LIKE "%'.$search.'%"   ');
}
?>
   ...
   <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"> Listes des fournisseurs </strong>
                            </div>
                            <div class="card-body">
                ...
                <a href="supprimerfournisseur.php?del=<?php echo $row['idF']; ?>" class="btn btn-danger btn-xs"><i class ="fa fa-trash-o"> </i> Delete</a>
                                             </td>
                                        </tr>
