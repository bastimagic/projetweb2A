...
$result=$db->query('select * from livreur ORDER BY nom');
?>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"> Listes des Livreurs </strong>
                            </div>
                            <div class="card-body">
                            ...
                            <a href="modifierlivreur1.php?id=<?PHP echo $row['id']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
