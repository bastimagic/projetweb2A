...
$result=$db->query('select * from produit p inner join categorie c where p.idC = c.idC order by idP desc');
?>
                                   ...
                                   <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>  
                <a href="modifierproduit.php?edit=<?php echo $row['idP']; ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> Edit </a>
                
                <a href="supprimerproduit.php?del=<?php echo $row['idP']; ?>" class="btn btn-danger btn-xs"><i class ="fa fa-trash-o"> </i> Delete</a>
                                             </td>
                                        </tr>
