...
<strong> Modifier Livreur</strong> Détails
</div>
...
<div class="col-12 col-md-9"><input type="number" id="id" name="id" placeholder="*******" class="form-control" value="<?PHP echo $id ?>"> <small class="form-text text-muted"></small></div>
</div>
<div class="row form-group">
<div class="col col-md-3"><label class=" form-control-label">nom</label></div>
<div class="col-12 col-md-9"><input type="text" id="text-input" name="nom"  class="form-control" value="<?PHP echo $nom ?>" ><small class="form-text text-muted"></small></div>
</div>
<div class="row form-group">
<div class="col col-md-3"><label for="adresse" class=" adresse">prenom </label></div>
<div class="col-12 col-md-9"><input type="text" id="prenom" name="prenom" placeholder="  " class="form-control" value="<?PHP echo $prenom ?>" ><small class="help-block form-text"></small></div>
</div>
<div class="row form-group">
<div class="col col-md-3"><label class=" form-control-label">numero</label></div>
<div class="col-12 col-md-9"><input type="number" id="text-input" name="numero" placeholder="*******" class="form-control" value="<?PHP echo $numero ?>"> <small class="form-text text-muted"></small></div>
</div>
<div class="card-footer">
<input type="submit" name="modifier"class="btn btn-warning btn-xs" value="modifier">
<td><input type="hidden" name="id_ini" value="<?PHP echo $_GET['id'];?>"></td>
<a href="tablelivreur.php" class="btn btn-info btn-xs"> view </a>
...
$livreur=new livreur($_POST['id'],$_POST['nom'],$_POST['prenom'],$_POST['numero']);
