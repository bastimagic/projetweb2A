...
<body>
 ...
 <form method="POST" action="ajoutproduit.php"  onsubmit="aaa()">
              ...
              <strong> Ajouter un produit</strong> Détails
                                                    ...
                                                    <div class="card-body card-block">
                                                            ...
                                                            <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="file" id="text-input" name="imageP"  class="form-control"><small class="form-text text-muted"></small></div>
                                                         ...
                                                         <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" name="nomP" id="nomP" class="form-control"><small class="form-text text-muted"></small></div>
                                                                <span id='missPrenom'></span><br>

                                                            </div>
                                                        <div class="row form-group">
                                                                <div class="col col-md-3"><label class=" form-control-label">Descrption du produit</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="descP" name="descP"  class="form-control"><small class="form-text text-muted"></small></div>
                                                                <div class="col-12 col-md-9">
                                                           ...
                                                           <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="number" id="qteP" 
                                                                    name="qteP"  class="form-control"><small class="help-block form-text"> </small></div>
                                                            </div>
                                                            <div class="row form-group">
                          ...
                          <!--  <div class="row form-group">
                               ...
                               <select data-placeholder="Choose a Country..." class="standardSelect" tabindex="10">
