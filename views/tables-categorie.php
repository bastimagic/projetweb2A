...
$result=$db->query('select * from categorie order by idC desc');
?>

<?php  
if (isset($_GET['search'])&&!empty($_GET['search'])) {
    $search=htmlspecialchars($_GET['search']);
    $result=$db->query('select * from categorie WHERE nomC LIKE "%'.$search.'%"   ');
}
?>
   ...
   <div id="right-panel" class="right-panel">
        ...
        <div class="content mt-3">
            <div class="animated fadeIn">
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title"> Listes Categorie </strong>
                            </div>
                            <div class="card-body">
                ...
                <a href="supprimercategorie.php?del=<?php echo $row['idC']; ?>" class="btn btn-danger btn-xs"><i class ="fa fa-trash-o"> </i> Delete</a>
