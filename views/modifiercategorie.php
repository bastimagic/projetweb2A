...
$idC = $_GET['edit'];
$emps=$db->query("SELECT * FROM  categorie WHERE idC=$idC");
    ...
    <div id="right-panel" class="right-panel">
     ...
     <form method="POST" action="editcat.php">
        <div class="card-header">
          ...
          <div class="card-header">
              <strong> Mofifier une categorie</strong> Détails
            </div>
                                                    <div class="card-body card-block">
                                                               
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label class=" form-control-label">Nom categorie  </label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="img" name="nomC" value="<?php echo $nomC;?>" class="form-control"><small class="form-text text-muted"></small></div>
