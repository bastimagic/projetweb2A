...
<strong> Modifier livraison</strong> Détails
</div>
<div class="card-body card-block">
<form  method="POST" enctype="multipart/form-data" class="form-horizontal" name="clientf">
<div class="row form-group">
<div class="col col-md-3"><label class=" form-control-label">idL</label></div>
<div class="col-12 col-md-9"><input type="number" id="text-input" name="idL" placeholder="*******" class="form-control" value="<?PHP echo $idL ?>"> <small class="form-text text-muted"></small></div>
</div>
<div class="row form-group">
<div class="col col-md-3"><label class=" form-control-label">ID_commande</label></div>
<div class="col-12 col-md-9"><input type="text" id="text-input" name="ID_commande"  class="form-control" value="<?PHP echo $ID_commande ?>" ><small class="form-text text-muted"></small></div>
</div>
<div class="row form-group">
<div class="col col-md-3"><label for="adresse" class=" adresse">adresse </label></div>
<div class="col-12 col-md-9"><input type="text" id="adresse" name="adresse" placeholder="  " class="form-control" value="<?PHP echo $adresse ?>" ><small class="help-block form-text"></small></div>
</div>
<div class="row form-group">
<div class="col col-md-3"><label class=" form-control-label">date</label></div>
<div class="col-12 col-md-9"><input type="date" id="text-input" name="date" placeholder="*******" class="form-control" value="<?PHP echo $date ?>"> <small class="form-text text-muted"></small></div>
</div>
<div class="card-footer">
<input type="submit" name="modifier" class="btn btn-warning btn-xs"value="modifier">
<td><input type="hidden" name="idL_ini" value="<?PHP echo $_GET['idL'];?>"></td>
<a href="tablelivraison.php" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i> view </a>
...
$livraison=new livraison($_POST['idL'],$_POST['ID_commande'],$_POST['adresse'],$_POST['date']);
$livraisonC->modifierlivraison($livraison,$_POST['idL_ini']);
echo $_POST['idL_ini'];
}
?>   
</div>  
