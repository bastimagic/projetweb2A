...
$idF = $_GET['edit'];
$emps=$db->query("SELECT * FROM  fournisseur WHERE idF=$idF");
           while ($row = $emps->fetch()) {
            $idF= $row['idF'];
            $nomF = $row['nomF'];
            $adresseF = $row['adresseF'];
            $telF = $row['telF'];
            $idC = $row['idC'];
        }
?>
...
<body>
  ...
  <li class="menu-item-has-children dropdown">
    ...
    <div id="right-panel" class="right-panel">
     ...
     <form method="POST" action="editfourn.php">
        <div class="card-header">
        
         </div>
          <div class="card-header">
              <strong> Mofifier un fournisseur</strong> Détails
            </div>
                                                    <div class="card-body card-block">
                                                               
                                                            <div class="row form-group">
                                                                <div class="col col-md-3"><label class=" form-control-label">Nom du fournisseur  </label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="img" name="nomF" value="<?php echo $nomF;?>" class="form-control"><small class="form-text text-muted"></small></div>
                                                         ...
                                                         <div class="row form-group">
                                                                ...
                                                                <div class="col-12 col-md-9"><input type="text" id="adresseF" name="adresseF" value="<?php echo $adresseF;?>" class="form-control"><small class="form-text text-muted" required></small></div>
                                                            </div>
                                                        <div class="row form-group">
                                                                <div class="col col-md-3"><label class=" form-control-label">Tel du fournisseur</label></div>
                                                                <div class="col-12 col-md-9"><input type="text" id="telF" name="telF" value="<?php echo $telF;?>"  class="form-control"><small class="form-text text-muted"></small></div>
                        ...
                        <div class="col col-md-3"><label class=" form-control-label" >Catégorie du produit </label></div>
                           ...
                           <div class="col-12 col-md-9">
                            ...
                            <input type="hidden" name="idFe"  value="<?php echo $idF;?>" >
