...
<div class="super_container">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logoff1" style="margin-left: -70px" >
							<IMG src="LogoID.jpg">
						</div>
					</div>
										...
										<div class="custom_dropdown">
											<div class="custom_dropdown_list">
												...
												<ul class="custom_list clc">
													...
													<li><a class="clc" href="#">School supplies</a></li>
													<li><a class="clc" href="#">Schoolbag & kit</a></li>
													<li><a class="clc" href="#">Office supply</a></li>
													<li><a class="clc" href="#">High-tech</a></li>
													<li><a class="clc" href="#">Ink cartridge</a></li>
												</ul>
											</div>
										</div>
					...
					<div class="col">
						...
						<div class="main_nav_content d-flex flex-row">
							...
							<div class="cat_menu_container">
								...
								<ul class="cat_menu">
									<li><a href="#">School supplies <i class="fas fa-chevron-right ml-auto"></i></a></li>
									<li><a href="#">Schoolbag & kit<i class="fas fa-chevron-right"></i></a></li>
									<li class="hassubs">
										<a href="#">Office supply<i class="fas fa-chevron-right"></i></a>
										<ul>
											<li class="hassubs">
									...
									<li><a href="#">High-tech<i class="fas fa-chevron-right"></i></a></li>
									<li><a href="#">Ink cartridge<i class="fas fa-chevron-right"></i></a></li>
								</ul>
							</div>
	...
	<div class="home">
		...
		<div class="home_content d-flex flex-column align-items-center justify-content-center">
			<h2 class="home_title">Hight-Tech</h2>
		</div>
	</div>
...
<?php
							...
							<div class="product_item">
								...
								<div class="product_content">
									<div class="product_price"><?php echo $key['prixP'] ;?>DT</div>
