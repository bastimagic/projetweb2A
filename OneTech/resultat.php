				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo" style="margin-top: -15px">
							<IMG src="LogoID.png" style="margin-left: -70px">
						</div>
					</div>
				...
				<div class="col-lg-3">
					...
					<div class="shop_sidebar">
						...
						<div class="sidebar_section">
							<div class="sidebar_subtitle brands_subtitle">Categorie</div>
							<ul class="brands_list">
								<?php
								foreach ($result6 as $key) {
									# code...
								?>
									<li class="brand"><a href="shop.php?cat=<?php echo $key['idC'];?>"><?php echo $key['nomC'];?></a></li>
...
<?php } $select_terme->closeCursor(); ?> 
						...
						<div class="shop_bar clearfix">
							...
							<div class="shop_product_count"><span><?php echo $Pfound ?></span> products found</div>
