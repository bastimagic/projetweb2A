...
$query=$db->prepare('SELECT * from produit p inner join categorie c where p.idC=c.idC and idP=:cat');
				...
				<div class="row">
					...
					<div class="col-lg-2 col-sm-3 col-3 order-1">
						<div class="logo" style="margin-left: -70px">
							<IMG src="LogoID.png" style="margin-top: -30px">
						</div>
					</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="images/<?php echo $result['imageP'];?>" alt=""></div>
				</div>
					...
					<div class="product_description">
						...
						<div class="order_info d-flex flex-row">
							<form action="#">
								...
								<div class="product_price"><?php echo $result['prixP'];?> DT</div>
