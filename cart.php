...
<?php
								if (!empty($somm) and !empty($date))
						 	 {
								  foreach($list_prod as $row){
    								...
    								$dataprod = $pr->recupererproduit($row['id_produit']);
									foreach ($dataprod as $row1) {
										$nam =  $row1['nomP'];
									    $imag =  $row1['imageP'];
									    $prix = $row1['prixP'];
									}
								...
								?>
   									 ...
   									 <td><img src="images/<?php echo $imag; ?>" alt="" width= "72px" height="72px"></td>
   									 		 <td><?php echo $row['id_produit']; ?></td>
   									 		 		 <td><?php echo $nam; ?></td>
   									 <td><?php echo $prix; ?></td>
  										  <td>	<div class="cart_item_total cart_info_col">
